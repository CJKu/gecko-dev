...
nsFrame::DidSetStyleContext(nsStyleContext* aOldStyleContext)
{
  ...
  if (oldBG) {
    NS_FOR_VISIBLE_CSS_LAYERS_BACK_TO_FRONT(i, oldBG->mLayers) {
  ...
  NS_FOR_VISIBLE_CSS_LAYERS_BACK_TO_FRONT(i, newBG->mLayers) {
  ...
  if (oldSVGReset) {
    NS_FOR_VISIBLE_CSS_LAYERS_BACK_TO_FRONT(i, oldSVGReset->mLayers) {
  ...
  NS_FOR_VISIBLE_CSS_LAYERS_BACK_TO_FRONT(i, newSVGReset->mLayers) {
