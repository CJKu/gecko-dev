...
const KTableValue nsCSSProps::kImageLayerAttachmentKTable[] = {
...
const KTableValue nsCSSProps::kImageLayerOriginKTable[] = {
...
const KTableValue nsCSSProps::kImageLayerPositionKTable[] = {
...
const KTableValue nsCSSProps::kImageLayerRepeatKTable[] = {
...
const KTableValue nsCSSProps::kImageLayerRepeatPartKTable[] = {
  eCSSKeyword_no_repeat,  NS_STYLE_IMAGELAYER_REPEAT_NO_REPEAT,
  eCSSKeyword_repeat,     NS_STYLE_IMAGELAYER_REPEAT_REPEAT,
  eCSSKeyword_UNKNOWN,-1
};

const KTableValue nsCSSProps::kImageLayerSizeKTable[] = {
