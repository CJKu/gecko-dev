                                ...
                                const RuleNodeCacheConditions aConditions)
{
  ...
  // and remove one property in nsCSSLayers::Layer.
  // +: this attribute does not exist in nsCSSLayers::Layers
  // X: nsCSSLayers::Layers has this attribute but mask-image does not need it.
  //
  // (OK) mask-image
  ...
  SetBackgroundList(aContext, *aRuleData->ValueForMaskImage(),
                    svgReset->Layers(),
                    parentSVGReset->Layers(), &nsCSSLayers::Layer::mImage,
  ...
  SetBackgroundPairList(aContext, *aRuleData->ValueForMaskRepeat(),
                        svgReset->Layers(),
                        parentSVGReset->Layers(), &nsCSSLayers::Layer::mRepeat,
  ...
  SetBackgroundList(aContext, *aRuleData->ValueForMaskClip(),
                    svgReset->Layers(),
                    parentSVGReset->Layers(), &nsCSSLayers::Layer::mClip,
                    uint8_t(NS_STYLE_BG_CLIP_BORDER), parentSVGReset->mLayers.mClipCount,
  ...
  SetBackgroundList(aContext, *aRuleData->ValueForMaskOrigin(),
                    svgReset->Layers(),
                    parentSVGReset->Layers(), &nsCSSLayers::Layer::mOrigin,
                    uint8_t(NS_STYLE_BG_ORIGIN_PADDING), parentSVGReset->mLayers.mOriginCount,
  ...
  SetBackgroundList(aContext, *aRuleData->ValueForMaskPosition(),
                    svgReset->Layers(),
                    parentSVGReset->Layers(), &nsCSSLayers::Layer::mPosition,
  ...
  SetBackgroundPairList(aContext, *aRuleData->ValueForMaskSize(),
                        svgReset->Layers(),
                        parentSVGReset->Layers(), &nsCSSLayers::Layer::mSize,
  ...
  SetBackgroundList(aContext, *aRuleData->ValueForMaskMode(),
                    svgReset->Layers(),
                    parentSVGReset->Layers(), &nsCSSLayers::Layer::mMode,
                    uint8_t(NS_STYLE_MASK_MODE_AUTO), parentSVGReset->mLayers.mModeCount,
                    svgReset->mLayers.mModeCount, maxItemCount, rebuild, conditions);

  // mask-composition: add | subtract | intersect | exclude
  SetBackgroundList(aContext, *aRuleData->ValueForMaskComposite(),
                    svgReset->Layers(),
                    parentSVGReset->Layers(), &nsCSSLayers::Layer::mComposite,
                    uint8_t(NS_STYLE_MASK_COMPOSITE_ADD), parentSVGReset->mLayers.mCompositeCount,
  ...
  if (rebuild) {
    ...
    for (uint32_t i = 0; i < fillCount; i++) {
      ...
      svgReset->mLayers[i].mBlendMode = NS_STYLE_BLEND_NORMAL;
    }

    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mImage,
                       svgReset->mLayers.mImageCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mRepeat,
                       svgReset->mLayers.mRepeatCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mClip,
                       svgReset->mLayers.mClipCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mOrigin,
                       svgReset->mLayers.mOriginCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mPosition,
                       svgReset->mLayers.mPositionCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mSize,
                       svgReset->mLayers.mSizeCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mMode,
                       svgReset->mLayers.mModeCount, fillCount);
    FillBackgroundList(svgReset->Layers(), &nsCSSLayers::Layer::mComposite,
